...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap uniscaledBitmap = decodeImageFile(path);

        bitmap = setupBitmapSize(uniscaledBitmap);
...
//                dialog.dismiss();
    ...
    public Bitmap setupBitmapSize(Bitmap bitmap){
        ...
        if (width>=1500||higth>=1500){

            if (width>=higth){

                Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap,2000,2000*higth/width,true);
                ...
                Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap,2000*width/higth,2000,true);
    ...
    public static Bitmap decodeImageFile(String path) {
        ...
        try {
            ...
            rotatedBitmap = Bitmap.createBitmap(unscaledBitmap,0,0, unscaledBitmap.getWidth(), unscaledBitmap.getHeight(), matrix, true);
